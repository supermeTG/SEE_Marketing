...
public class RuleEngineDemo {
    public static void main(String[] args) throws Exception {
        ...
        FlinkKafkaConsumer<String> kafkaSource = new FlinkKafkaConsumer<>("zenniu_applog", new SimpleStringSchema(), props);
        ...
        SingleOutputStreamOperator<ResultBean> resultStream = keyed.process(new KeyedProcessFunction<String, LogBean, ResultBean>() {
            ...
            public void open(Configuration parameters) throws Exception {
                ...
                table = conn.getTable(TableName.valueOf("zenniu_profile"));
