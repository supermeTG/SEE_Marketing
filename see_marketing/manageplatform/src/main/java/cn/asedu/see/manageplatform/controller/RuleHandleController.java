package cn.asedu.see.manageplatform.controller;

import cn.asedu.see.manageplatform.pojo.RuleDefine;
import cn.asedu.see.manageplatform.pojo.RuleStatus;
...
public class RuleHandleController {
    ...
    private  void insertRule2Mysql(String ruleName) throws Exception {
        ...
        Connection conn = DriverManager.getConnection("jdbc:mysql://node01:3306/realtimedw?useUnicode=true&characterEncoding=utf8", "root", "123456");
